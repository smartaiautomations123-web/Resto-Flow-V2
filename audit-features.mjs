...
for (const [module, moduleFeatures] of Object.entries(features)) {
  ...
  for (const [feature, requirements] of Object.entries(moduleFeatures)) {
    ...
    // Check tables
    if (requirements.tables && requirements.tables.length > 0) {
    ...
    // Check functions
    if (requirements.functions && requirements.functions.length > 0) {
    ...
    // Check procedures
    if (requirements.procedures && requirements.procedures.length > 0) {
